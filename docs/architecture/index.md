...
This domain owns current, version-locked system truth. Proposed directions do
not become architecture until they are accepted and implemented.

- [Hybrid runtime boundaries](../architecture.md)
