...
documented in the [data-connector reference](data-connectors.md). The
[host-pipeline explanation](../explanation/host-pipelines.md) describes why
they remain outside this portable contract.
