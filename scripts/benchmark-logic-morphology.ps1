...
$outputRoot = Join-Path $projectRoot "out\logic-morphology"
...
$build = Join-Path $projectRoot "out\logic-morphology-build"
...
python (Join-Path $projectRoot "examples\logic_morphology.py") `
    --data-dir $dataRoot `
